...
<div class="loader-wrapper" id="pleasewait" style="display: none;">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
	...
	<a class="navbar-brand header-logo" href=""> <img src="\images\pdcalogo.png" alt="pdca logo" height="39px" width="89px">
 ...
 <%-- <div class="nav d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" id="userDropdown">
  ...
  <div id="wrapper">
    ...
    <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#" style="float: right;margin-left: auto;">
      <i class="fas fa-bars"></i>
    </button>
...
<!-- 
    ...
    <section id="plant" style="padding-top: 50px; display: none">
	  ...
	  <section id="pillar" style="padding-top: 50px; display: none">
		<div class="container-fluid">
			...
			<div>
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Pillar%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="pillar-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="pillar-pillarName" id="pillar-pillarName">
							</div>
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								<label class="">Pillar Type <span class="text-danger">*</span></label>
								<input  data-required="yes" data-type="text" type="text" class="form-control"name="pillar-pillarType" id="pillar-pillarType">
							</div>
							<!-- <div class="form-group col-md-6 cus-formgroup-sm" id="">
								<label class="">Location <span class="text-danger">*</span></label>
								<input  data-required="yes" data-type="text" type="text" class="form-control"name="plant-location" id="plant-location">
				...
				<div class="modal-content">
								...
								<form class="md-form" id="bulkuploadpillarmasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadpillarmasterinput"  name="files" onchange="checkfile(this);">
										</div>
					...
					<div class="modal-footer">
						<a class="btn btn-default btn-sm" id=""
							style="margin-right: auto;">Clear</a> <a
							class="btn btn-default btn-sm" data-dismiss="modal">Cancel</a>
						<button class="btn btn-success btn-sm" id="pillarmasterbulkSaveBtn">Save</button>
					</div>
				</div>
			</div>
		</div>
	  ...
	  <section id="area" style="padding-top: 50px; display: none">
		<div class="container-fluid">
			...
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Area%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="area-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="area-areaName" id="area-areaName">
							</div>
							<div class="form-group col-md-6" style="display:none">
						    <label >Plant Id</label>
						      <select  data-required="yes" data-type="text" id="area-plantId" name="area-plantId" class="js-data-example-ajax autocompleteforxcnreportssearch"  style="width: 100%">
						     </select>
							</div>
							<div class="form-group col-md-6">
						    <label >Plant Name</label>
						      <select  data-required="yes" data-type="text" id="area-plantName" name="area-plantName" class="js-data-example-ajax autocompleteforxcnreportssearch"  style="width: 100%">
						     </select>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadareamasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadareamasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
	...
	<section id="line" style="padding-top: 50px; display: none">
		<div class="container-fluid">
			...
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Line%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="area-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="line-lineName" id="line-lineName">
							</div>
							<div class="form-group col-md-6" style="display:none">
						    <label >Plant Id</label>
						      <select  data-required="yes" data-type="text" id="line-plantId" name="line-plantId" class="js-data-example-ajax autocompleteforxcnreportssearch"  style="width: 100%">
						     </select>
							</div>
							<div class="form-group col-md-6">
						    <label >Plant Name</label>
						      <select  data-required="yes" data-type="text" id="line-plantName" name="line-plantName" class="js-data-example-ajax autocompleteforxcnreportssearch"  style="width: 100%">
						     </select>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadlinemasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadlinemasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
		...
		<div class="container-fluid">
			...
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-LossType%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="losstype-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="losstype-losstypeName" id="losstype-losstypeName">
							</div>
						</form>
					</div>
					<div class="modal-footer">
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadlosstypemasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadlosstypemasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
 ...
 <section id="tool" style="padding-top: 50px; display: none">
		<div class="container-fluid">
			...
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Tool%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="tool-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="tool-toolName" id="tool-toolName">
							</div>
						</form>
					</div>
					<div class="modal-footer">
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadtoolmasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadtoolmasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
		...
		<div class="container-fluid">
			...
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Benefit%20Type%20Master-Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="benefit-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<input data-required="yes" data-type="text" type="text" class="form-control"name="benefit-benefitName" id="benefit-benefitName">
							</div>
						</form>
					</div>
					<div class="modal-footer">
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadbenefitmasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadbenefitmasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
	...
	<section id="masterConfiguration" style="padding-top: 50px; display: none">
		<div class="container-fluid">
			...
			<div>
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-Master%20BulkUpload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
				<table class="table table-striped table-bordered nowrap"
					...
					<div class="modal-body" id="">
						<form class="row selfalign-bottom" id="masterConfiguration-form">
							<div class="form-group col-md-6 cus-formgroup-sm" id="">
								...
								<div>
									<select disabled data-required="yes" theme="bootstrap" data-type="text" type="text" class="form-control"name="masterConfiguration-type" id="masterConfiguration-type" class="js-data-example-ajax"
										 style="width: 100%">
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadmasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadmasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
	...
	<section id="userrole" style="display: none;">
		<div class="container-fluid">
			...
			<div>
			<div><a href="https://storage.cloud.google.com/pdca-test-1.appspot.com/RequestAttachments/Template-User%20Bulk%20Upload.xlsx?src=ac" download>Click here to download Template for Bulk upload</a></div>
				<br/>
			<div>
				<table class="table table-striped table-bordered nowrap"
						...
						<form class="row selfalign-bottom" id="userrole-form">
							<div class="form-group col-md-12 cus-formgroup-sm">
								...
								<div class="form-inline" id="">
									...
									<div class="form-group col-md-6">
										<input type="checkbox" name="userrole-approver1" id="userrole-approver1"
											class="filled-in" value="APPROVER1"> <label
											for="userrole-approver1" style="padding-left: 30px;">Pillar Approver</label>
									</div>
									<div class="form-group col-md-6">
										<input type="checkbox" name="userrole-approver2" id="userrole-approver2"
											class="filled-in" value="APPROVER2"> <label
											for="userrole-approver2" style="padding-left: 30px;">CD for Financial Approver</label>
									</div>
									<div class="form-group col-md-6">
										<input type="checkbox" name="userrole-approver3" id="userrole-approver3"
											class="filled-in" value="APPROVER3"> <label
											for="userrole-approver3" style="padding-left: 30px;">WCM/FI Approver</label>
									</div>
								<div class="form-group col-md-6">
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="">
								<form class="md-form" id="bulkuploadusermasterform">
									<div class="file-field">
										<div class="btn btn-primary btn-sm float-left">
											 <input type="file" id="bulkuploadusermasterinput"  name="files" onchange="checkfile(this);">
										</div>
										<div style="display:none"class="file-path-wrapper">
											<input class="file-path validate" type="text"
												placeholder="Upload your file">
  ...
  <tr>
    ...
    <td class="tg-0pky">Nick Jose</td>
        		 ...
        		 <ul class="list-unstyled attachdesign imageattach">
        			 <li id="1562668493079">
        		 		<div class="cloneimage">
        		 			...
        		 			<a class="filedownld workpermitfiledownload" data-link="/attachments/FileDownload?type=WorkPermitAttachments&amp;attchemnetID=1562668493079&amp;filename=hero-thankyou.jpg&amp;refID=" data-filetype="file" data-file="hero-thankyou.jpg" data-attachmentid="1562668493079">hero-thankyou.jpg</a><span class="attchmentdelete"><i class="fa fa-times"></i></span>
        		 	</li>
        		 	<li id="1562668477961">
        		 		<div class="cloneimage">
        		 			<img src="https://www.w3schools.com/w3images/lights.jpg">
        		 		</div>
        		 		<a class="filedownld workpermitfiledownload" data-link="/attachments/FileDownload?type=WorkPermitAttachments&amp;attchemnetID=1562668477961&amp;filename=hero-people.jpg&amp;refID=" data-filetype="file" data-file="hero-people.jpg" data-attachmentid="1562668477961">hero-people.jpg</a><span class="attchmentdelete"><i class="fa fa-times"></i></span>
        		 	</li>
        		 	<li id="1562668493079">
        		 		<div class="cloneimage">
        		 			<img src="https://www.w3schools.com/w3images/lights.jpg">
      ...
      <div class="col-sm-6"><span><b>Team Menbers : Nick Jose, Rama, Dinesh Kumar, Matt Jose</b></span></div>
	    ...
	    <div class="modal-dialog modal-notify modal-info" role="document">
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-footer justify-content-center">
	                <button type="submit" class="btn btn-danger btn-sm" id="rejectpermitmodalbtn">Reject</button>
	...
	<div class="modal fade" id="approvepermit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    <div class="modal-dialog modal-notify modal-info" role="document">
	        <!--Content-->
	        <div class="modal-content">
	            <!--Header-->
	            ...
	            <!--Footer-->
	            <div class="modal-footer justify-content-center">
	                <button type="submit" class="btn btn-success btn-sm" id="approvepermitmodalbtn">Approve</button>
	                <button class="btn btn-default btn-sm" data-dismiss="modal">Cancel</button>
	            </div>
	        </div>
	        <!--/.Content-->
		...
		function updateModal(user){
			...
			populatejs({
				...
				"userrole-userName":user.userName,
				 "userrole-pillarName":user.pillarName,
				 "userrole-plantName":user.plantName,
				 "userrole-mentor":user.mentor,
				 "userrole-editor":user.editor,
				 "userrole-projectLead":user.projectLead,
				 "userrole-pillarLead":user.pillarLead
			});
