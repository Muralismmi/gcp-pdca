...
import com.helper.HeaderFooterPageEvent;
...
public class RequestController {
	...
	public @ResponseBody String saveRequest(HttpServletRequest request, @RequestParam("requestobj") String requestobj, @RequestParam("variableconfigdata") String variableconfigdata) throws JsonGenerationException, JsonMappingException, IOException {
	...
	public @ResponseBody String setid(HttpServletRequest request)
	...
	public @ResponseBody String updateRequest(HttpServletRequest request, @RequestParam("requestobj") String requestobj, @RequestParam("variableconfigdata") String variableconfigdata) throws JsonGenerationException, JsonMappingException, IOException {
	...
	public @ResponseBody String getrequest(HttpServletRequest request, @RequestParam("requestid") String requestID) throws JsonGenerationException, JsonMappingException, IOException {
						 ...
						 if(userJdoObj.getRoles().contains("SUPERADMIN")) {
							 ...
							 if((userJdoObj.getRoles().contains("PLANTMANAGER") || userJdoObj.getRoles().contains("EDITOR") ) 
									...
									responseMap.put("data",objRequest);
								 	...
								 	responseMap.put("STATUS", "FAILURE");
									responseMap.put("MESSAGE", "Sorry, You do not have permission to access this Request");
							 }
						 }
					}
	 ...
	 @RequestMapping(value = "/createpdfanddownload2", method = RequestMethod.GET)
	   	public @ResponseBody void createPDFandDownload2(@RequestParam("filename") String reqid,HttpServletResponse resp)
	   	{
	           try
	           {
	...
	public  PdfPCell getValueList(List<String> data,Request req) throws JsonParseException, JsonMappingException, IOException, DocumentException{
		...
		case "formType":
				         ...
				         cell.setBorderColor(WebColors.getRGBColor("#333"));cell.addElement(p);;
	...
	public @ResponseBody String getPillarLead(HttpServletRequest request) throws JsonGenerationException, JsonMappingException, IOException {
		UserDAO userDao = new UserDAOImpls();
		User objUser = null;
	 ...
	 @SuppressWarnings("unchecked")
		...
		public @ResponseBody void sendnotificationtonextapprover(HttpServletRequest req) {
